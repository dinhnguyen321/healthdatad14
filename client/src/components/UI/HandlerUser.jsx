...
function CrudUser({setOpen,setTitlePopup,titlePopup,data}) {
    ...
    return (
        <div className='fixed inset-0 flex items-center justify-center z-90'>
            <div className='w-full lg:w-4/5 border mx-auto text-black rounded-lg z-100 max-h-[90vh] overflow-y-auto'>
              ...
              {titlePopup === "edit" ? "Chỉnh sửa" : ""}
              {titlePopup === "detail" ? "Xem chi tiết" : ""}
              {titlePopup === "add" ? "Thêm mới" : ""}
              </h2>
             <button
              onClick={() =>(
                setTitlePopup(""),
            ...
            <div className='grid grid-cols-12 p-5'>
                ...
                <div className='flex gap-x-5'>
                    ...
                    />
                        ...
                        onChangeInput={onChangeInput}
                        title={titlePopup}
                        value={dataUser.education_level} 
