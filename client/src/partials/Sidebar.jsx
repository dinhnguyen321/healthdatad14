         ...
         <div className='space-y-4'>
           <h3 className="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
            ...
            viewBox="-2.5 -2.5 30.00 30.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#dedede" transform="rotate(0)matrix(1, 0, 0, 1, 0, 0)" stroke-width="0.00025"><g id="SVGRepo_bgCarrier" stroke-width="0" 
             ...
             <svg  className="p-0 lg:p-2 w-6 h-6 lg:w-16 lg:h-16" viewBox="-7.2 -7.2 38.40 38.40" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0)"><g id="SVGRepo_bgCarrier" stroke-width="0" transform="translate(2.3999999999999986,2.3999999999999986), scale(0.8)"><rect x="-7.2" y="-7.2" width="38.40" height="38.40" rx="19.2" 
