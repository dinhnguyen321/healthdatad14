  ...
  useEffect(() => {
    ...
    return (
      ...
      ></div>
        ...
        <div id="sidebar"
        ref={sidebar}
        className={`flex lg:flex! flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-[100dvh] overflow-y-scroll lg:overflow-y-auto no-scrollbar w-40 lg:w-60 shrink-0 bg-white dark:bg-gray-800 py-4 transition-all duration-200 ease-in-out 
          ${sidebarOpen ? "translate-x-0" : "-translate-x-64"} 
          ${variant === 'v2' ? 'border-r border-gray-200 dark:border-gray-700/60' : 'rounded-r-2xl shadow-xs'}`}
        >
        {/* Header sidebar */}
        <div className='p-4 pb-8 border-b-blue-200 border-b-2 text-center'>
          {/* Close button */}
          <button
            ref={trigger}
          ...
          */}  <svg className="w-6 h-w-6 text-violet-600 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M10.7 18.7l1.4-1.4L7.8 13H20v-2H7.8l4.3-4.3-1.4-1.4L4 12z" />
            </svg> 
          </button>
              {/* Logo */}
              <NavLink end to="/" className="flex-row lg:flex justify-between items-center">
              ...
              <h2 className='font-bold text-xs lg:text-2xl pt-2 lg:pt-0'>
                HealthData
              </h2>
            </NavLink>
        </div>
